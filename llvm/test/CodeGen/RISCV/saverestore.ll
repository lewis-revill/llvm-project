...
; RUN: llc -mtriple=riscv32 -mattr=+f -target-abi=ilp32f -enable-save-restore < %s | FileCheck %s -check-prefix=RV32I-FP-SR
; RUN: llc -mtriple=riscv64 -mattr=+f,+d -target-abi=lp64d -enable-save-restore < %s | FileCheck %s -check-prefix=RV64I-FP-SR
